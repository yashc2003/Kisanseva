 ...
 function Product18()  {
    ...
    return(
        ...
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/nitro-1.jpg" alt=".."/>
        </div>
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/phos-1.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/pota-1.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/calc.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/sulp-1.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/magnesium-5.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
       ...
       <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/boron-4.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/zinc-4.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/iron-5.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
