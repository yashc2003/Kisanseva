 ...
 function Product23()  {
    ...
    return(
        ...
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/nitro-14.jpg" alt=".."/>
        </div>
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/phos-8.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/pota-8.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/cal-10.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
    ...
    <div class="mainbox1">
        <div class="left-card1">
            <img class="productimg1" src="https://ariesagro.com/wp-content/uploads/2022/12/zinc-1.jpg" alt=".."/>
        </div>
         <div class="middle-card1 ps-4">
